...
<title>Sungei Gerchang Estate (SGE) </title>
...
<br>
 ...
 <h3><center>SUNGEI GERCHANG ESTATE (SGE)</center></h3>
 </div>
...
<br><br>
				...
				$sql = "SELECT * FROM newstaff WHERE dep = 'Sungei Gerchang Estate'";
				
				$sql = "SELECT * FROM staffinfo WHERE dep = 'Sungei Gerchang Estate'";
				...
				<a href="http://localhost/ajpn/sge.php" button class="button">BACK</button></a>
