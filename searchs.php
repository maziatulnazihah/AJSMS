...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `newstaff` WHERE CONCAT(`s_id`, `name`, `designation`, `dep`, `type`, `startD`,`salary`)LIKE'%".$valueToSearch."%'";
  ...
  <div class="main">
		...
		<div class="box">
				...
				<h3>SEARCH DEPARTMENT</h3>
				  <p align="center"><input type="text" size="50" name="valueToSearch" placeholder="Search"><br>
				  <p align="center"><input type="submit" class="btn2" name="search" value="Search"></i><br><br>
				  <table border="1px">
			   ...
			   <tr>
				 <?php while($row = mysqli_fetch_array($search_result)):?>
				  ...
				  <td><center><?php echo"<a href=\"searchs1.php?ID=".$row["s_id"]."\"class= btn1>VIEW MORE</a>"?></center></td>
				</tr>
				 <?php endwhile;?>
