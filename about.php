...
<center>
<div class="btn-group">
  <a href="http://localhost/ajpn/philosophy.php" button class="button">VISION, MISSION, PHILOSOPHY</a></button><br>
  <img src="1.jpg" alt="Girl in a jacket" width="1000.7" height="200"><br>
  <br><a href="http://localhost/ajpn/abouthr.php" button class="button">ABOUT ACHI JAYA PLANTATIONS</a></button><br>
   <img src="36.jpg" alt="Girl in a jacket" width="1000.7" height="200"><br><br>

<br><br>
<center><a href="http://localhost/ajpn/homepagehr.php" button class="button1">BACK</button></a></center>
 <br><br>
</center>
</div>
