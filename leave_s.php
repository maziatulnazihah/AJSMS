...
<center><div class="box">
 <h1><center>LEAVE APPLICATION REQUEST LIST</center></h1><br>
 <center><table border= "1px" size="450px">
				...
				echo "<tr><th>NAME</th><th>DESIGNATION</th><th>DEPARTMENT</th><th>ACTION</th><th>ACTION</th></tr>	";
				...
				while($row = mysqli_fetch_assoc($result)){
							...
							echo"<td><center><a href=\"nlvview.php?ID=".$row["id"]."\" class = btn1>VIEW MORE</a></center><br>";
							echo"<td><center><a href=\"nlvdel.php?ID=".$row["id"]."\" class = btn2><img src=del.png style=width:15px;height:20px></a></center><br>";
