...
<br>
 ...
 <h3><center>PAYROLL DETAILS</center></h3>
 </div>
<br>
 <table border= "1px">
				...
				$sql = "SELECT * FROM bankacc WHERE s_id = $s_id"; //tukar kt categories kalau nk lunch, dinner, etc...
				$result = mysqli_query($conn,$sql);
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						 ...
						 echo "<tr><b>DESIGNATION:</b></tr>";
						 echo "<tr><p>" .$row["des"]. "</p></tr>";
						 echo "<tr><b>DEPARTMENT:</b></tr>";
						 echo "<tr><p>" .$row["dep"]. "</p></tr>";
						 echo "<tr><b>DATE:</b></tr>";
						 echo "<tr><p>" .$row["date"]. "</p></tr>";
						 echo "<tr><b>BANK NAME:</b></tr>";
						 echo "<tr><p>" .$row["bankN"]."</p></tr>";
						 echo "<tr><b>BANK ACCOUNT:</b></tr>";
						 echo "<tr><p>" .$row["bankAcc"]."</p></tr>";
						 echo "<tr><b>TOTAL AMMOUNT:</b></tr>";
						 echo "<tr><p>" .$row["totalA"]."</p></tr>";
						 echo "<tr><b>STATUS:</b></tr>";
						 echo "<tr><p>" .$row["status"]."</p></tr>";
				...
				<center>
				<a href="http://localhost/ajpn/payrolls.php"><input type="button" class="button" value="BACK"></a>
