...
<center>
 <div class="box">
 <h1><center>PAYROLL LIST</center></h1><br>
			 <center><table border= "1px" size="450px">
				...
				echo "<tr><th>STAFF NAME</th><th>DESIGNATION</th><th>DEPARTMENT</th><th>BANK NAME</th><th>ACTION</th><th>ACTION</th></tr>	";
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						...
						echo "</tr>";
							...
							echo"<td><a href=\"bankedit.php?ID=".$row["s_id"]."\" div class=btn1><img src=e.png style=width:20px;height:20px></a></center></td>";
							echo"<td><center><a href=\"bankdel.php?ID=".$row["s_id"]."\" class=btn2><img src=del.png style=width:15px;height:20px></a></center></i></center></td>";
				...
				<center>
				<br><br>
				<a href="http://localhost/ajpn/bankadd.php" button class="button"> ADD NEW <i class="fa fa-plus" aria-hidden="true"></i></button></a>
