...
<br>
 ...
 <h3><center>MESSAGE LIST</center></h3>
 </div>
...
<br><br>
 <table border= "1px">
		...
		<table>
				...
				$sql = "SELECT * FROM contact WHERE id = $id"; //tukar kt categories kalau nk lunch, dinner, etc...
				$result = mysqli_query($conn,$sql);
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
						 ...
						 echo "<tr><b>EMAIL:</b><br>". $row["email"]."</tr><br><br>";
						 echo "<tr><b>MESSAGE:</b><br>" .$row["message"]. "</p></tr>";
				...
				<a href="http://localhost/ajpn/contactlist.php#" button class="button">BACK</button></a>
