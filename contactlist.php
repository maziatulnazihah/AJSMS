...
<center><div class="box">
 <h1><center>MESSAGE LIST</center></h1><br>
 <center><table border= "1px" size="450px" style="color:red">
				...
				$sql = "SELECT * FROM contact"; //tukar kt categories kalau nk lunch, dinner, etc...
				$result = mysqli_query($conn,$sql);
					
				echo "<tr><th>NAME</th><th>EMAIL</th><th>MESSAGE</th><th>ACTION</th><th>ACTION</th></tr>	";
				...
				while($row = mysqli_fetch_assoc($result)){
							...
							echo "<td>" .$row["message"]; echo "</td>";
							
							
							echo"<td><center><a href=\"cview.php?ID=".$row["id"]."\" class = btn1>VIEW MORE</a></center></td>";
							echo"<td><center><a href=\"cdelete.php?ID=".$row["id"]."\" class= btn3><img src=del.png style=width:15px;height:20px></a></center></td>";
				...
				<center>
			<br>
				<a href="http://localhost/ajpn/contact.php" button class="button">BACK</button></a>
