...
<html>
<head>
<title>Estate  And Sustainability/OSH Department</title>
...
<br><br>
 ...
 <h3><center>ESTATE AND SUSTAINABILITY/OSH DEPARTMENT</center></h3>
 </div>
 <br><br>
 <table border= "1px">
 	...
 	<?php
				...
				$sql = "SELECT * FROM newstaff WHERE dep = 'Estate and Sustainability/OSH'";
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
							...
							echo"<td><center><a href=\"esv.php?ID=".$row["s_id"]."\" class = btn1>VIEW MORE</a></center></td>";
							echo "</tr>";
						} 
