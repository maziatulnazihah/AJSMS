...
<title>Edit Leave Application Request</title>
			<style>
				* {
...
<form action="leaveupdate.php?ID=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
<center><br>
<div class="main"> 
	...
	<table width ="450px">
			...
			<center>		
			   	...
			   	<input type="submit" class="button" name="insert" value="SAVE">
					...
					<a href="http://localhost/ajpn/nlvL.php" button class="button">BACK</button></a>
