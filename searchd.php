  ...
  <div class="main">
		...
		<div class="box">
				...
				<h3>SEARCH PAYROLL</h3>
				  ...
				  <p align="center"><input type="submit" button class="btn2"name="search" value="Search"></i><br><br>
			   ...
			   <tr>
				 <?php while($row = mysqli_fetch_array($search_result)):?>
				  ...
				  <td><?php echo $row['bankN'];?></td>
				  <td><center><?php echo"<a href=\"searchd1.php?ID=".$row["s_id"]."\"class= btn1>VIEW MORE</a>"?><center></td>
				</tr>
				 <?php endwhile;?>
