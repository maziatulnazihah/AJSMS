...
<html>
<head>
<title>Johor Labis Estate (JLE)</title>
...
<br><br>
 ...
 <h3>JOHOR LABIS ESTATE (JLE)</h3><br>
 </div>
<br><br>
 ...
 <table border= "1px">
 	...
 	<?php
				...
				$sql = "SELECT * FROM newstaff WHERE dep ='Johore Labis Estate'"; //tukar kt categories kalau nk lunch, dinner, etc...
				$result = mysqli_query($conn,$sql);
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
							...
							echo"<td><center><a href=\"jlev.php?ID=".$row["s_id"]."\" class = btn1>VIEW MORE</a></center></td>";
							echo "</tr>";
