...
.about-section {
  background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.8)), url(t.jpg);
  padding: 100px;
  text-align: center;
  color: #fff;
}
...
<br>
<div class="div2"><a href="http://localhost/ajpn/contact2.php" class="button">CONTACT US</a><a href="http://localhost/ajpn/about2.php" class="button">ABOUT US</a></div>
<br><br><br>
