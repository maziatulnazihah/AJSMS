...
<title>New Staff Details List</title>
		<style>
...
<center><div class="box">
 <h1><center>NEW STAFF DETAILS LIST</center></h1>
 <center><table border= "1px" size="450px" style="color:red">
				...
				echo "<tr><th>STAFF ID</th><th>PHOTO</th><th>NAME</th><th>DESIGNATION</th><th>DEPARTMENT</th><th>ACTION</th><th>ACTION</th><th>ACTION</th></tr>	";
				...
				while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
							...
							echo"<td><center><a href=\"nsv.php?ID=".$row["s_id"]."\" class = btn1><img src=v.png style=width:30px;height:20px></a></center></td>";
							echo"<td><center><a href=\"nsedit.php?ID=".$row["s_id"]."\" class=btn2><img src=edit.png style=width:20px;height:20px></center></td>";
							echo"<td><center><a href=\"nsdelete.php?ID=".$row["s_id"]."\" class= btn3><img src=del.png style=width:20px;height:20px></a></center></td>";
