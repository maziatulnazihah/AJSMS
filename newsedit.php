...
<div class="main"> 
	...
	<center><table width ="450px">
					...
					<tr>
						...
						<td>
							<br><select input="input-field" class="custom" name="state" placeholder="State" value="<?php echo $row['state'];?>">
			...
			<center>			
				...
				<a href="http://localhost/ajpn/newsL.php" button class="button">BACK</button></a>
