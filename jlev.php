...
<title>Johor Labis Estate</title>
...
<br>
 ...
 <h3><center>JOHORE LABIS ESTATE (JLE)</center></h3>
 </div>
...
<br><br>
				...
				$sql = "SELECT * FROM newstaff WHERE dep = 'Johor Labis Estate'";
			...
			<a href="http://localhost/ajpn/jle.php" button class="button">BACK</button></a>
