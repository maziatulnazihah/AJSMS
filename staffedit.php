...
<html>
<head>
<title>Staff Information Edit</title>
...
<?php
				...
				?>
	<form action="staffupdate.php?ID=<?php echo $s_id;?>" method="POST" enctype='multipart/form-data'>
	<center>
	...
	<center><table width ="450px">
		...
		<tr>
					...
					<tr>
						...
						<td>
							<br><select input="input-field" class="custom" name="dep" value="<?php echo $row['dep'];?>">
				...
				<a href="http://localhost/ajpn/staffinfo.php" button class="button">BACK</button></a>
