...
<center>
 <div class="box">
 <h1><center>HUMAN RESOURCE</center></h1>
 ...
 <table border= "1px">
				...
				$sql = "SELECT * FROM jobinfo WHERE dep = 'Human Resource'";
				...
				<a href="http://localhost/ajpn/hr.php"><input type="button" class="button" value="BACK"></a>
