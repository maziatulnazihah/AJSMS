...
<br>
 ...
 <h3><center>PALM OIL MILL (POM)</center></h3>
 </div>
 <table border= "1px">
 ...
 <br>
				...
				$sql = "SELECT * FROM newstaff WHERE dep = 'Palm Oil Mill'";
				...
				<a href="http://localhost/ajpn/pom.php" button class="button">BACK</button></a>
