...
<title>Leave Application Request List</title>
...
<center><div class="box">
 <h1><center>LEAVE APPLICATION REQUEST LIST</center></h1>
 <center><table border= "1px" size="450px">
				...
				while($row = mysqli_fetch_assoc($result)){
							...
							echo"<td><center><a href=\"nlvedit.php?ID=".$row["id"]."\" class = btn1><img src=edit.png style=width:18px;height:20px></a></center></td>";
							echo"<td><center><a href=\"nlvdelete.php?ID=".$row["id"]."\" class= btn2><img src=del.png style=width:15px;height:20px></a></center></td>";
