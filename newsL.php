...
<title>Staff Information List</title>
		<style>
...
<center><div class="box">
 <h1><center>STAFF INFORMATION LIST</center></h1><br>
				...
				if(mysqli_num_rows($result)>0){
					...
					while($row = mysqli_fetch_assoc($result)){
                        ...
                        $image_src = "image/".$image;
							...
							echo "<td><img src=".$image_src." width='75' height='85' ></td>";
							echo "<td>". $row["name"]; echo"</td>";
							echo "<td>" .$row["designation"];echo "</td>";
							echo "<td>" .$row["dep"]; echo "</td>";
							
							
							echo"<td><center><a href=\"newsview.php?ID=".$row["s_id"]."\" class = btn1>VIEW MORE</a></center></td>";
							echo"<td><center><a href=\"newsedit.php?ID=".$row["s_id"]."\" class=btn2><img src=edit.png style=width:20px;height:20px></center></td>";
							echo"<td><center><a href=\"newsdel.php?ID=".$row["s_id"]."\" class= btn3><img src=del.png style=width:13px;height:20px></a></center></td>";
